#define MAX_OBJECT_MODEL_NAME 20

enum e_ObjectModels
{
	e_ObjectModelID,
	e_ObjectModelName[MAX_OBJECT_MODEL_NAME char]
}

new const g_ObjectModels[][e_ObjectModels] =
{
    ...
    {19510, !"lshouse3int"}, {19511, !"lshouse4"}, {19512, !"lshouse4int"}, {19346, !"hotdog01"}, {19513, !"whitephone"},
	{19514, !"SWATHgrey"}, {19515, !"SWATAgrey"},
	...
	{19558, !"PizzaHat1"}, {19559, !"HikerBackpack1"}, {19560, !"MeatTray1"}, {19561, !"CerealBox1"}, {19562, !"CerealBox2"},
	{19563, !"JuiceBox1"}, {19564, !"JuiceBox2"}, {19565, !"IceCreamBarsBox1"}, {19566, !"FishFingersBox1"},
	{19567, !"IcecreamContainer1"}, {19568, !"IcecreamContainer2"}, {19569, !"MilkCarton1"}, {19570, !"MilkBottle1"},
	{19571, !"PizzaBox1"}, {19572, !"PisshBox1"}, {19573, !"BriquettesBag1"}, {19574, !"Orange1"},
	{19575, !"Apple1"}, {19576, !"Apple2"}, {19577, !"Tomato1"}, {19578, !"Banana1"},
	{19579, !"BreadLoaf1"}, {19580, !"Pizza1"}, {19581, !"MarcosFryingPan1"}, {19582, !"MarcosSteak1"},
	{19583, !"MarcosKnife1"}, {19584, !"MarcosSaucepan1"}, {19585, !"MarcosPan1"}, {19586, !"MarcosSpatula1"},
	{19587, !"PlasticTray1"}, {19588, !"FootBridge1"}, {19589, !"RubbishSkipEmpty1"}, {19590, !"WooziesSword1"},
	{19591, !"WooziesHandFan1"}, {19592, !"ShopBasket1"}, {19593, !"ZomboTechBuilding1"}, {19594, !"ZomboTechLab1"},
	{19595, !"LSAppartments1"}, {19596, !"LSBeachSide"}, {19597, !"LSBeachSideInsides"}, {19601, !"SnowPlow1"},
	{19602, !"Landmine1"}, {19603, !"WaterPlane1"}, {19604, !"WaterPlane2"}, {19605, !"EnExMarker4-2"},
	{19606, !"EnExMarker4-3"}, {19607, !"EnExMarker4-4"}, {19608, !"WoodenStage1"}, {19609, !"DrumKit1"},
	{19610, !"Microphone1"}, {19611, !"MicrophoneStand1"}, {19612, !"GuitarAmp1"}, {19613, !"GuitarAmp2"},
	{19614, !"GuitarAmp3"}, {19615, !"GuitarAmp4"}, {19616, !"GuitarAmp5"}, {19617, !"GoldRecord1"},
	{19618, !"Safe1"}, {19619, !"SafeDoor1"}, {19620, !"LightBar1"}, {19621, !"OilCan1"},
	{19622, !"Broom1"}, {19623, !"Camera1"}, {19624, !"Case1"}, {19625, !"Ciggy1"},
	...
	{19730, !"MTubeHalf45Bend4"}, {19731, !"TubeHalfMtoSJoin1a"}, {19732, !"TubeHalfMtoSJoin1B"}, {19733, !"STubeSeg5m1"},
	{19734, !"STubeSeg5m2a"}, {19735, !"STubeSeg5m2b"}, {19736, !"STubeSeg6_25m1"}, {19737, !"STubeHalf10m1"},
	{19738, !"STubeHalf5mJoin1a"}, {19739, !"STubeHalf5mJoin1b"}, {19740, !"STubeHalf12_5m1"}, {19741, !"STubeFlat6_25m1"},
	{19742, !"STubeHalfSpiral1a"}, {19743, !"STubeHalfSpiral1b"}, {19744, !"STubeHalfSpiral2a"}, {19745, !"STubeHalfSpiral2b"},
	{19746, !"STubeHalfSpiral3a"}, {19747, !"STubeHalfSpiral3b"}, {19748, !"STubeHalfSpiral4a"}, {19749, !"STubeHalfSpiral4b"},
	{19750, !"STubeHalf180Bend1a"}, {19751, !"STubeHalf180Bend1b"}, {19752, !"STubeHalf90Bend1a"}, {19753, !"STubeHalf90Bend1b"},
	{19754, !"STubeHalf12_5mDip1"}, {19755, !"STubeHalf12_5mBump1"}, {19756, !"STubeHalfBowl1"}, {19757, !"STubeSupport1"},
	{19758, !"STubeSupport2"}, {19759, !"STubeHalfLight1"}, {19760, !"STubeHalf5Bend1a"}, {19761, !"STubeHalf5Bend1b"},
	{19762, !"STubeHalf5Bend2a"}, {19763, !"STubeHalf5Bend2b"}, {19764, !"STubeHalf45Bend1a"}, {19765, !"STubeHalf45Bend1b"},
	{19766, !"STubeHalf15Bend1a"}, {19767, !"STubeHalf15Bend1b"}, {19768, !"STubeHalf15Bend2a"}, {19769, !"STubeHalf15Bend2b"},
	{19770, !"STubeHalf45Bend3"}, {19771, !"STubeHalf45Bend4"}, {19772, !"CrushedCarCube1"}, {19773, !"GunHolster1"},
	{19774, !"PoliceBadge2"}, {19775, !"PoliceBadge3"}, {19776, !"FBIIDCard1"}, {19777, !"FBILogo1"},
	{19778, !"InsigniaDetective1"}, {19779, !"InsigniaDetective2"}, {19780, !"InsigniaDetective3"}, {19781, !"InsigniaSergeant1"},
	{19782, !"InsigniaSergeant2"}, {19783, !"InsigniaPOfficer2"}, {19784, !"InsigniaPOfficer3"}, {19785, !"InsigniaSeniorLdOff"},
	{19786, !"LCDTVBig1"}, {19787, !"LCDTV1"}
};
new const g_MaxObjectModels = sizeof g_ObjectModels;

stock GetObjectModelName(modelid)
{
	new modelname[MAX_OBJECT_MODEL_NAME],
	    bool: model_found;

	for(new i; i < g_MaxObjectModels; i ++)
	{
		if(modelid != g_ObjectModels[i][e_ObjectModelID])
			continue;

		strunpack(modelname, g_ObjectModels[i][e_ObjectModelName]);
        model_found = true;
		break;
	}
